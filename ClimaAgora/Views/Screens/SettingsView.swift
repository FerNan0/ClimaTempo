...
struct SettingsView: View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 0) {
                accessibilityToggle(
                    ...
                    isOn: $accessibility.isSimplifiedMode
                )
                ...
                accessibilityToggle(
                    ...
                    isOn: $accessibility.useLargeIcons
                )
                ...
                accessibilityToggle(
                    ...
                    isOn: $accessibility.showVisualSummary
                )
                ...
                accessibilityToggle(
                    icon: "eye.slash",
                    iconColor: .blue,
                    title: "Reduzir Informações",
                    subtitle: "Mostra só o essencial",
                    isOn: $accessibility.reduceInformation
                )
                ...
                accessibilityToggle(
                    ...
                    iconColor: .pink,
                    title: "Vibração Reforçada",
                    subtitle: "Vibra mais forte ao tocar nos botões",
                    isOn: $accessibility.enhancedHaptics
                )
            }
            .padding(.vertical, 4)
                ...
                Button(action: {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 10)
                            .fill(
                                LinearGradient(
                                    colors: [Color.pink.opacity(0.75), Color.red.opacity(0.55)],
                                    startPoint: .leading,
                                    endPoint: .trailing
                                )
                            )
    ...
    private func accessibilityToggle(icon: String, iconColor: Color, title: String, subtitle: String, isOn: Binding<Bool>) -> some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 1) {
                Text(title)
                    ...
                    .foregroundColor(Color(red: 0.18, green: 0.18, blue: 0.3))
                Text(subtitle)
